...
##  B. Cache
    **Problema** No se envia cache** La cache no alamacenaba informacion  local 
    **Solucion** La cache fue solucionada con  almacenamiento localstorage 

## C. HTML

    **Problema** No aparecen los datos registrados
    **Solucion** Los datos furon ingresados para visualizar el contenido